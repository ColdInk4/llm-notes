...
![6-0-3D模型和三角形的计算](images/6-0-3D模型和三角形的计算.png)
...
![6-1-GPU和CPU的结构](images/6-1-GPU和CPU的结构.png)
...
![6-1-GPU的结构](images/6-2-GPU的结构.png)
...
![6-3-GPU核心的架构.png](images/6-3-GPU核心的架构.png)
...
![6-4-SM的架构.png](images/6-4-SM的架构.png)
...
![6-5-SM的执行.png](images/6-5-SM的执行.png)
...
![6-28-内存模型.png](images/6-28-内存模型.png)
...
![6-6-GPU的内存模型.png](images/6-6-GPU的内存模型.png)
...
![6-7-TPU的抽象模型.png](images/6-7-TPU的抽象模型.png)
...
![6-8-矩阵运算在各个设备的速度.png](images/6-8-矩阵运算在各个设备的速度.png)

从上图可以看出GPU的世系从P100开始，蓝色的非矩阵运算和黄色的矩阵运算就开始分道扬镳，展现了巨大的差异，这主要原因是GPU厂商特意为矩阵运算优化的张量核心（tensor core）是专门用于矩阵乘法的电路。

### 6.5.2 计算与内存扩展不平衡

![6-9-计算速度扩展的比内存扩展速度更快.png](images/6-9-计算速度扩展的比内存扩展速度更快.png)
...
![6-10-屋顶线模型.png](images/6-10-屋顶线模型.png)
...
![6-11-低精度提升速度.png](images/6-11-低精度提升速度.png)
...
![6-12-张量核心可进行的操作.png](images/6-12-张量核心可进行的操作.png)
...
![6-13-算子融合演示.png](images/6-13-算子融合演示.png)
...
![6-14-算子融合示例.png](images/6-14-算子融合示例.png)
...
![6-15-反向传播算法.png](images/6-15-反向传播算法.png)
...
![6-16-三个sigmoid函数堆叠.png](images/6-16-三个sigmoid函数堆叠.png)
...
![6-17-突发模式.png](images/6-17-突发模式.png)
...
![6-18-合并同一个线程块中的内存访问.png](images/6-18-合并同一个线程块中的内存访问.png)
...
![6-19-矩阵乘法的合并.png](images/6-19-矩阵乘法的合并.png)
...
![6-20-矩阵乘法分块.png](images/6-20-矩阵乘法分块.png)
...
![6-21-矩阵乘法分块（Tiling）化.png](images/6-21-矩阵乘法分块（Tiling）化.png)
...
![6-22-矩阵乘法分块的数学分析.png](images/6-22-矩阵乘法分块的数学分析.png)
...
![6-23-分块（Tiling）分块的复杂性.png](images/6-23-分块（Tiling）分块的复杂性.png)
...
![图6.24 FlashAttention V1原理图](images/6-24-注意力计算.png)
...
![图6.25 左图：前向传播+反向传播的运行时间；右图：注意力内存使用情况。](images/6-25-FlashAttention的图一.png)
...
![图6.26 传统KV Cache分布](images/6-26-两种softmax.png)
...
![图6.27 显存占用分析](images/6-27-flashAttention的向前传播.png)
...
![6-29-昇腾910B实测数据](images/6-29-昇腾910B实测数据.png)

英伟达A100实测数据：

![6-30-英伟达A100实测数据.png](images/6-30-英伟达A100实测数据.png)
