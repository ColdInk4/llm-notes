...
![7-1-矩阵运算时间.png](images/7-1-矩阵运算时间.png)
...
![7-2-缩放各种参数的规律](images/7-2-缩放各种参数的规律.png)
...
![7-3-加法的性能分析](images/7-3-sheep的性能分析.png)
...
```
![7-4-add的性能分析](images/7-4-add的性能分析.png)
...
![7-5-矩阵乘法的性能分析](images/7-5-矩阵乘法的性能分析.png)
...
![7-6-矩阵乘法的性能分析2](images/7-6-矩阵乘法的性能分析2.png)
...
![7-7-cdist的性能分析](images/7-7-cdist的性能分析.png)
...
![7-8-gelu的性能分析](images/7-8-gelu的性能分析.png)
...
![7-9-softmax的性能分析](images/7-9-softmax的性能分析.png)
...
![7-10-NsightSystems](images/7-10-NsightSystems.png)
...
![7-11-NsightSystems代码](images/7-11-NsightSystems代码.png)
...
![7-12-NsightSystems2](images/7-12-NsightSystems2.png)
...
![7-13-两个gelu的计算结果](images/7-13-两个gelu的计算结果.png)
...
![7-14-两个gelu的时间](images/7-14-两个gelu的时间.png)
...
![7-15-手动gelu的性能分析](images/7-15-手动gelu的性能分析.png)
...
![7-16-pytorch的gelu的性能分析](images/7-16-pytorch的gelu的性能分析.png)
...
![7-17-cuda的gelu的性能分析](images/7-17-cuda的gelu的性能分析.png)
...
![7-18-cuda的gelu的性能分析2](images/7-18-cuda的gelu的性能分析2.png)
...
![7-19-triton的gelu的性能分析](images/7-19-triton的gelu的性能分析.png)
...
![7-20-triton的gelu的性能分析](images/7-20-triton的gelu的性能分析2.png)
...
![7-21-compile的的时间消耗](images/7-21-compile的的时间消耗.png)

现在来看运行时间，手动8.1毫秒，PyTorch 1.1毫秒，CUDA 1.8毫秒，而torch.compile仅需 1.47毫秒。

![7-22-compil的gelu的性能分析](images/7-22-compil的gelu的性能分析.png)
