...
![图11.1 数据工程与大模型训练](images/11.1.png)
...
![图11.3 中期训练数据来源](images/11.3.png)
...
![图11.4 后期训练数据来源](images/11.4.png)
...
![图11.6 CCNet工作原理](images/11.6.png)
...
![图11.7 原始数据与处理后的数据关系](images/11.7.png)
...
![图11.9 Bloom Filter示意图](images/11.9.png)

*图11.9 Bloom Filter示意图*
...
![图11.10 bank与相似度关系](images/11.10.png)
...
![图11.11 数据评估大模型记忆行为](images/11.11.png)
