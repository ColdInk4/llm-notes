...
- 法律与数据安全：Bartz v. Anthropic PBC, Case No. 4:24-cv-05417-AMO (N.D. Cal.) [公开报道与和解页面](https://www.anthropiccopyrightsettlement.com/)、[Carlini 等](https://arxiv.org/abs/2302.10149)、[Schuster 等](https://arxiv.org/abs/2010.12563)、[毒样本规模无关性论文](https://arxiv.org/abs/2510.07192)；查阅日期：2026-09-22。
